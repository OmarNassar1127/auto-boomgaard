...
function HeroSection() {
  ...
  return (
    <div className="block block-full-screen has-background-image block-video video-element">
      ...
      <div
        className={`object-fit-wrapper video-wrapper video-wrapper-main-video ${
          mainVideoActive ? "active" : ""
        }`}
      >
        <video
          ref={mainVideoRef}
        ...
        <div
          className="pause-video pause-video-overlay"
          onClick={handlePauseMainVideo}
        ></div>
      </div>
          ...
          <div className="hero-content">
            <div className="item text">
              <h1>
                ...
                <span className="dp-block-tablet-m">
                  Audi, Mercedes en Volkswagen
                </span>
              </h1>
              <p>
                <a
                  className="btn btn-no-border btn-light link-with-icon"
                  href="#/aanbod/"
                >
                  <span
                    className="svg-icon-aanbod"
                    style={{
                      marginRight: "10px",
                      display: "inline-flex",
                      alignItems: "center",
