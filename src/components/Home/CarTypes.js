      ...
      <div className="container">
        <div className="header-content">
          ...
          <p className="description">
            Ruim 40 jaar toonaangevend in het exclusieve segment. Ons aanbod bestaat uit nieuwe en jong 
            gebruikte auto's, met zeer lage kilometerstanden en met volledige fabrieksgarantie.
          </p>
          <p className="occasions-text">
            Regelmatig hebben we <a href="/aanbod/" className="occasions-link">occasions</a> waar we trots op zijn ze te kunnen verkopen.
          </p>
        </div>
