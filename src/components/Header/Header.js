...
function Header() {
  ...
  return (
    <header
      id="site-header"
      className={`block block-full-width block-site-header block-site-header-show-extra-items block-site-header-hidden-nav block-site-header-overlay block-site-header-light ${scrolled ? 'scrolled' : ''}`}
    >
      ...
      <label htmlFor="header-nav-checkbox" className="header-nav-toggle-overlay" onClick={closeMenu}></label>
      ...
      <div className="">
        <div className="block-inner">
          ...
          <nav className="nav-extra">
            <ul className="hide-print">
              ...
              <li className="menu-item-menu menu-item-icon">
                <label htmlFor="header-nav-checkbox" className="menu-button" onClick={(e) => {e.preventDefault(); toggleMenu();}}>
          ...
          <nav className="header-nav-container hide-print" id="header-nav-container">
            {/* Close button */}
            <div className="header-search-close-wrapper">
              <button type="button" className="header-close" onClick={closeMenu} aria-label="Close menu">
