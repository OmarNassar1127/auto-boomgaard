  ...
  useEffect(() => {
    ...
    if (openingHours[dayName]) {
      ...
      if (openingHours[dayName].showroom === "Gesloten") {
        ...
        setShowroomStatus({
          open: true,
          times: openingHours[dayName].showroom,
        });
      }
      ...
      <div className="footer-content container">
        ...
        <div className="footer-top">
          ...
          <div className="footer-contact-btns">
            <a
              href="tel:+31499331881"
              className="btn"
              data-analytics="event"
              data-analytics-category="Footer"
              data-analytics-action="button"
              data-analytics-label="Bel ons"
            >
              ...
              <span className="label">+31646056382</span>
            </a>
          ...
          <div className="opening-hours">
            ...
            <div className="opening-hours-item">
              <span
                className="status"
                style={{
                  backgroundColor: showroomStatus.open ? "#28a745" : "#dc3545",
                }}
              ></span>
              <span className="place" style={{ textAlign: "left" }}>
                Showroom
              </span>
            ...
            <div className="opening-hours-item">
              <span
                className="status"
                style={{
                  backgroundColor: garageStatus.open ? "#28a745" : "#dc3545",
                }}
              ></span>
              <span className="place" style={{ textAlign: "left" }}>
                Garage
        ...
        <div className="footer-bottom">
          <div className="copyright">Copyright 2025 - Auto Boomgaard</div>

          <div className="social-media-links">
            <a
              href="https://www.facebook.com/pages/Vd-Akker/243312935679742"
              title="Facebook"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://instagram.com/akkernl/"
              title="Instagram"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.tiktok.com/@akkernl"
              title="TikTok"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.youtube.com/user/AkkerMTM"
              title="YouTube"
              target="_blank"
              rel="noopener noreferrer"
            >
