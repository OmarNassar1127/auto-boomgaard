      ...
      const mockVehicles = [
        {
          ...
          images: [
            ...
            "https://placehold.co/600x400/252525/FFF?text=Interior+View",
            "https://placehold.co/600x400/252525/FFF?text=Back+View",
            "https://placehold.co/600x400/252525/FFF?text=Side+View",
            "https://placehold.co/600x400/252525/FFF?text=Dashboard",
            "https://placehold.co/600x400/252525/FFF?text=Engine"
          ],
          status: "",
          favorite: false,
          specifications: {
        ...
        <div className="content-grid">
              ...
              <div className="specs-grid">
                ...
                <div className="spec-item">
                  ...
                  <div className="spec-detail">
                    ...
                    <div className="spec-value">{vehicle.specifications.fuel}</div>
                  </div>
                </div>
                <div className="spec-item">
                  <div className="spec-icon">
                ...
                <div className="spec-item">
                  ...
                  <div className="spec-detail">
                    ...
                    <div className="spec-value">{vehicle.specifications.color}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="sidebar">
            ...
            <div className="contact-box">
              ...
              <p>Neem direct contact met ons op voor meer informatie of een proefrit.</p>
            ...
            <div className="technical-specs">
              ...
              <div className="specs-list">
                <div className="spec-row">
                  ...
                  <div className="spec-value">{vehicle.specifications.bodyType}</div>
                </div>
                <div className="spec-row">
                ...
                <div className="spec-row">
                  ...
                  <div className="spec-value">{vehicle.specifications.doors}</div>
                </div>
                <div className="spec-row">
                  <div className="spec-name">Zitplaatsen</div>
                  <div className="spec-value">{vehicle.specifications.seats}</div>
                </div>
                <div className="spec-row">
                  <div className="spec-name">CO2-uitstoot</div>
                  <div className="spec-value">{vehicle.specifications.emissions}</div>
                </div>
                <div className="spec-row">
                  <div className="spec-name">Energielabel</div>
                  <div className="spec-value">{vehicle.specifications.energyLabel}</div>
                </div>
              </div>
            </div>
          </div>
